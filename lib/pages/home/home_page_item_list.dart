...
class HomePageItemList extends StatefulWidget {
  const HomePageItemList({Key? key}) : super(key: key);
  @override
  State<HomePageItemList> createState() => _HomePageItemListState();
}

class _HomePageItemListState extends State<HomePageItemList> {
  ...
  Widget build(BuildContext context) {
    ...
    void _pushDetailPage(Product product) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => ProductDetailHome(product: product)));
    }
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      ...
                                      child: DefaultIconBoxWithIcon(
                                        widgetIcon: product.favorite == true
                                            ? LineIcons.heartAlt
                                            : LineIcons.heart,
                                        defaultSize: 23,
